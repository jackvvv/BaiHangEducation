...
public class TimeSelector {
	 ...
	 * @param endDate
	 */
	public TimeSelector(Context context, String title,
			ResultHandler resultHandler, String startDate, String endDate) {
	...
	public TimeSelector(Context context, String title,
		...
		this(context, title, resultHandler, startDate, endDate);
	...
	private void initDialog() {
		if (seletorDialog == null) {
			seletorDialog = new Dialog(context, R.style.ActionSheetDialogStyle);
			seletorDialog.setCancelable(true);
			seletorDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
			seletorDialog.setContentView(R.layout.dialog_select_date);
	...
	private void initView(String title) {
		...
		tv_select.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				handler.handle(DateUtil.format(selectedCalender.getTime(),
						FORMAT_STR));
				seletorDialog.dismiss();
			}
		});
	...
	private void excuteScroll() {
		...
		// hour_pv.setCanScroll(hour.size() > 1 && (scrollUnits &
		// SCROLLTYPE.HOUR.value) == SCROLLTYPE.HOUR.value);
		// minute_pv.setCanScroll(minute.size() > 1 && (scrollUnits &
		// SCROLLTYPE.MINUTE.value) == SCROLLTYPE.MINUTE.value);
	}
