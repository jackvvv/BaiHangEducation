...
public class ConfirmOrderActivity extends BaseActivity {
    ...
    private String fundId, fundName, buyNum, price, orderId;
    private String payType = "2";//1：微信；2：支付宝；3：账户支付；
    ...
    private void getData() {
        ...
        tv_name.setText(fundName);
        tv_num.setText(buyNum + "份");
        tv_money.setText("¥ " + price);
        tv_time.setText(StringUtil.getCurrentDate());
    }
    ...
    void ic_wx() {
        ...
        ic_yue.setImageResource(R.drawable.ic_notcheck);
    ...
    void ic_yue() {
        ...
        ic_wx.setImageResource(R.drawable.ic_notcheck);
        ic_alipay.setImageResource(R.drawable.ic_notcheck);
        ic_yue.setImageResource(R.drawable.ic_checked);
    }
...
//                        payNum = orderString.split("=")[1];
    ...
    private void paySuccess(String s) {
        ...
        params.put("type", s);
        Log.i("tag", Constants.BASE_URL + "payStBussiness&" + params);
        client.post(Constants.BASE_URL + "payStBussiness", params, new AsyncHttpResponseHandler() {
            @Override
